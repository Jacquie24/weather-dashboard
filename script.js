$(document).ready(function () {
    ...
    function init() {
        var cityStorage = JSON.parse(
            localStorage.getItem("cityArray")
        );
        if (cityStorage !== null) {
            cityArray = cityStorage
    ...
    function displaySearch(cityNameVar) {
